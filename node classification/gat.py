    ...
    def __init__(self,
        ...
        if num_layers == 1:
            self.gat_layers.append(GATConv(
                ...
                feat_drop, attn_drop, last_residual, norm=last_norm))
        else:
            # input projection (no residual)
            self.gat_layers.append(GATConv(
                in_dim, num_hidden, nhead,
                feat_drop, attn_drop, residual, create_activation(activation), norm=norm))
            # hidden layers
            ...
            self.gat_layers.append(GATConv(
                ...
                feat_drop, attn_drop, last_residual, activation=last_activation, norm=last_norm))
